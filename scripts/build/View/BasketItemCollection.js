define(['exports', 'module', 'libs/backbone', './BasketItem', 'Model/BasketItemCollection', 'Model/ProductCollection', 'underscore'], function (exports, module, _libsBackbone, _BasketItem, _ModelBasketItemCollection, _ModelProductCollection, _underscore) {
    'use strict';
    ...
    var BasketItemCollection = (function (_Backbone$View) {
        ...
        _createClass(BasketItemCollection, [{
            ...
            value: function initialize(options) {
                ...
                this.collection = new _BasketItemCollectionModel['default']([], options);
            ...
            value: function onSaveItem(basketItem) {
                var existed = this.collection.findWhere({ basket: basketItem.get('basket'), product: basketItem.get('product') });

                if (existed) {
                    existed.set('itemsAmount', existed.get('itemsAmount') + 1);
                } else {
                    var basketItemData = _2['default'].clone(basketItem.attributes);
                    basketItemData.product = basketItemData.product || _productCollection['default'].firstId();
